...
world.camera.boundary = CCRect(0,0,20480,2048)
world.camera.followRatio = oVec2(0.02,0.02)

local bk = CCSprite("Dev/Sample/Unit1/bk.jpg")
...
suit(unit,"Dev/Sample/Unit1/girl")
...
suit(unit,"Dev/Sample/Unit1/miku")
world:addChild(unit)
...
unit.data = lastUnit
unit.reflexArc = "follow"
suit(unit,"Dev/Sample/Unit1/boy")
world:addChild(unit)
...
-- Use arrow keys from keyboard to control character
