return {
  ...
  coroutine = {
    type = "lib",
    description = "The operations related to coroutines comprise a sub-library of the basic library\nand come inside the table coroutine.\n\nLua supports coroutines, also called collaborative multithreading.\nA coroutine in Lua represents an independent thread of execution.\nUnlike threads in multithread systems, however, a coroutine only suspends its\nexecution by explicitly calling a yield function.",
    childs = {
      create = {
        type = "function",
