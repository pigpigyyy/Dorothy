...
void CCEGLViewProtocol::setFrameSize(const CCSize& size)
{
	m_obDesignResolutionSize = m_obScreenSize = size;
}
...
void CCEGLViewProtocol::setViewPortRect(const CCRect& rect)
{
	this->setViewPortInPoints(rect.origin.x, rect.origin.y, rect.size.height, rect.size.width);
}
